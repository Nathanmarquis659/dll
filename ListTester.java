...
public class ListTester {
	...
	private void runTests() {
		...
		testSingleElementList(A_NextASetB_B, "A_NextASetB_B", LIST_B, STRING_B);
		testSingleElementList(A_PreviousASetB_B, "A_PreviousASetB_B", LIST_B, STRING_B);
		...
		testSingleElementList(AB_iterRemoveAfterNextB_A, "AB_iterRemoveAfterNextB_A", LIST_A, STRING_A);
		testSingleElementList(AB_iterRemoveAfterPreviousA_B, "AB_iterRemoveAfterPreviousA_B", LIST_B, STRING_B);
		testSingleElementList(AB_iterRemoveAfterPreviousB_A, "AB_iterRemoveAfterPreviousB_A", LIST_A, STRING_A);
		...
		testTwoElementList(A_iterAddB_BA, "A_iterAddB_BA", LIST_BA, STRING_BA);
		testTwoElementList(A_iterNextAddB_AB, "A_iterNextAddB_AB", LIST_AB, STRING_AB);
		testTwoElementList(A_iterPreviousAddB_BA, "A_iterPreviousAddB_BA", LIST_BA, STRING_BA);
		...
		testTwoElementList(AB_iterNextASetC_CB, "AB_iterNextASetC_CB", LIST_CB, STRING_CB);
		testTwoElementList(AB_iterNextBSetC_AC, "AB_iterNextBSetC_AC", LIST_AC, STRING_AC);
		testTwoElementList(AB_iterPreviousASetC_CB, "AB_iterPreviousASetC_CB", LIST_CB, STRING_CB);
		testTwoElementList(AB_iterPreviousBSetC_AC, "AB_iterPreviousBSetC_AC", LIST_AC, STRING_AC);
		...
		testTwoElementList(ABC_iterRemoveAfterPreviousB_AC, "ABC_iterRemoveAfterPreviousB_AC", LIST_AC, STRING_AC);
		testTwoElementList(ABC_iterRemoveAfterPreviousC_AB, "ABC_iterRemoveAfterPreviousC_AB", LIST_AB, STRING_AB);
		//3-element to changed 3-element via set()
		testThreeElementList(ABC_iterNextASetD_DBC,"ABC_iterNextASetD_DBC" , LIST_DBC, STRING_DBC);
		testThreeElementList(ABC_iterNextBSetD_ADC,"ABC_iterNextBSetD_ADC" , LIST_ADC, STRING_ADC);
		testThreeElementList(ABC_iterNextCSetD_ABD,"ABC_iterNextCSetD_ABD" , LIST_ABD, STRING_ABD);
		testThreeElementList(ABC_iterPreviousASetD_DBC,"ABC_iterPreviousASetD_DBC" , LIST_DBC, STRING_DBC);
		testThreeElementList(ABC_iterPreviousBSetD_ADC,"ABC_iterPreviousBSetD_ADC" , LIST_ADC, STRING_ADC);
		testThreeElementList(ABC_iterPreviousCSetD_ABD,"ABC_iterPreviousCSetD_ABD" , LIST_ABD, STRING_ABD);
		...
		testThreeElementList(AB_iterNextAAddC_ACB,"AB_iterNextAAddC_ACB" , LIST_ACB, STRING_ACB);
		testThreeElementList(AB_iterNextBAddC_ABC,"AB_iterNextBAddC_ABC" , LIST_ABC, STRING_ABC);
		testThreeElementList(AB_iterPreviousAAddC_CAB,"AB_iterPreviousAAddC_CAB" , LIST_CAB, STRING_CAB);
		testThreeElementList(AB_iterPreviousBAddC_ACB,"AB_iterPreviousBAddC_ACB" , LIST_ACB, STRING_ACB);
	...
	/** Scenario: A -> remove(0) -> empty list 
	...
	/** Scenario: empty list -> iterator add(A) -> [A] 
	...
	/** Scenario: [A] -> next A set(B) -> [B] 
	 * @return [B] after next A set(B)
	 */
	private IndexedUnsortedList<Integer> A_NextASetB_B() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.set(ELEMENT_B);
	...
	private Scenario<Integer> A_NextASetB_B = () -> A_NextASetB_B();

	/** Scenario: [A] -> previous A set(B) -> [B] 
	 * @return [B] after previous A set(B)
	 */
	private IndexedUnsortedList<Integer> A_PreviousASetB_B() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.set(ELEMENT_B);
	...
	private Scenario<Integer> A_PreviousASetB_B = () -> A_PreviousASetB_B();
	...
	private Scenario<Integer> AB_iterRemoveAfterPreviousA_B = () -> AB_iterRemoveAfterPreviousA_B();

	/** Scenario: [A,B] -> iteratorRemoveAfterPreviousB -> [A] 
	 * @return [A] after iteratorRemoveAfterPreviousB
	 */
	private IndexedUnsortedList<Integer> AB_iterRemoveAfterPreviousB_A() {
		IndexedUnsortedList<Integer> list = A_addB_AB(); 
	...
	private Scenario<Integer> AB_iterRemoveAfterPreviousB_A = () -> AB_iterRemoveAfterPreviousB_A();

	/** Scenario: [A,B] -> iteratorNextASetC -> [C,B] 
	 * @return [C,B] after iteratorNextASetC
	 */
	private IndexedUnsortedList<Integer> AB_iterNextASetC_CB() {
		IndexedUnsortedList<Integer> list = A_addB_AB(); 
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.set(ELEMENT_C);
	...
	private Scenario<Integer> AB_iterNextASetC_CB = () -> AB_iterNextASetC_CB();

	/** Scenario: [A,B] -> iteratorNextBSetC -> [A,C] 
	 * @return [A,C] after iteratorNextBSetC
	 */
	private IndexedUnsortedList<Integer> AB_iterNextBSetC_AC() {
		IndexedUnsortedList<Integer> list = A_addB_AB(); 
		ListIterator<Integer> it = list.listIterator(1);
		it.next();
		it.set(ELEMENT_C);
	...
	private Scenario<Integer> AB_iterNextBSetC_AC = () -> AB_iterNextBSetC_AC();

	/** Scenario: [A,B] -> iteratorPreviousASetC -> [C,B] 
	 * @return [C,B] after iteratorPreviousASetC
	 */
	private IndexedUnsortedList<Integer> AB_iterPreviousASetC_CB() {
		IndexedUnsortedList<Integer> list = A_addB_AB(); 
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.set(ELEMENT_C);
	...
	private Scenario<Integer> AB_iterPreviousASetC_CB = () -> AB_iterPreviousASetC_CB();

	/** Scenario: [A,B] -> iteratorPreviousBSetC -> [A,C] 
	 * @return [A,C] after iteratorPreviousBSetC
	 */
	private IndexedUnsortedList<Integer> AB_iterPreviousBSetC_AC() {
		IndexedUnsortedList<Integer> list = A_addB_AB(); 
		ListIterator<Integer> it = list.listIterator(2);
		it.previous();
		it.set(ELEMENT_C);
	...
	private Scenario<Integer> AB_iterPreviousBSetC_AC = () -> AB_iterPreviousBSetC_AC();
	...
	/** Scenario: A -> iterator add(B) -> [B,A] 
	 * @return [B,A] after iterator add(B)
	 */
	private IndexedUnsortedList<Integer> A_iterAddB_BA() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		ListIterator<Integer> it = list.listIterator();
		it.add(ELEMENT_B);
		return list;
	}
	private Scenario<Integer> A_iterAddB_BA = () -> A_iterAddB_BA();

	/** Scenario: A -> iterator nextA add(B) -> [A,B] 
	 * @return [A,B] after iterator nextA add(B)
	 */
	private IndexedUnsortedList<Integer> A_iterNextAddB_AB() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.add(ELEMENT_B);
	...
	private Scenario<Integer> A_iterNextAddB_AB = () -> A_iterNextAddB_AB();

	/** Scenario: A -> iterator previousA add(B) -> [B,A] 
	 * @return [B,A] after iterator previousA add(B)
	 */
	private IndexedUnsortedList<Integer> A_iterPreviousAddB_BA() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.add(ELEMENT_B);
	...
	private Scenario<Integer> A_iterPreviousAddB_BA = () -> A_iterPreviousAddB_BA();
	...
	/** Scenario: [A,B,C] -> iteratorRemoveAfterPreviousA -> [B,C] 
	 * @return [B,C] after iteratorRemoveAfterPreviousA
	 */
	...
	/** Scenario: [A,B,C] -> iteratorRemoveAfterPreviousB -> [A,C] 
	 * @return [A,C] after iteratorRemoveAfterPreviousB
	 */
	private IndexedUnsortedList<Integer> ABC_iterRemoveAfterPreviousB_AC() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC(); 
		ListIterator<Integer> it = list.listIterator(2);
		it.previous();
		it.remove();
	...
	private Scenario<Integer> ABC_iterRemoveAfterPreviousB_AC = () -> ABC_iterRemoveAfterPreviousB_AC();

	/** Scenario: [A,B,C] -> iteratorRemoveAfterPreviousC -> [A,B] 
	 * @return [A,B] after iteratorRemoveAfterPreviousC
	 */
	private IndexedUnsortedList<Integer> ABC_iterRemoveAfterPreviousC_AB() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC(); 
	...
	private Scenario<Integer> ABC_iterRemoveAfterPreviousC_AB = () -> ABC_iterRemoveAfterPreviousC_AB();

	/** Scenario: [A,B,C] -> iteratorNextASetD -> [D,B,C] 
	 * @return [D,B,C] after iteratorNextASetD
	 */
	private IndexedUnsortedList<Integer> ABC_iterNextASetD_DBC() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC(); 
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_iterNextASetD_DBC = () -> ABC_iterNextASetD_DBC();

	/** Scenario: [A,B,C] -> iteratorNextBSetD -> [A,D,C] 
	 * @return [A,D,C] after iteratorNextBSetD
	 */
	private IndexedUnsortedList<Integer> ABC_iterNextBSetD_ADC() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC(); 
		ListIterator<Integer> it = list.listIterator(1);
		it.next();
		it.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_iterNextBSetD_ADC = () -> ABC_iterNextBSetD_ADC();

	/** Scenario: [A,B,C] -> iteratorNextCSetD -> [A,B,D] 
	 * @return [A,B,D] after iteratorNextCSetD
	 */
	private IndexedUnsortedList<Integer> ABC_iterNextCSetD_ABD() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC(); 
		ListIterator<Integer> it = list.listIterator(2);
		it.next();
		it.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_iterNextCSetD_ABD = () -> ABC_iterNextCSetD_ABD();

	/** Scenario: [A,B,C] -> iteratorPreviousASetD -> [D,B,C] 
	 * @return [D,B,C] after iteratorPreviousASetD
	 */
	private IndexedUnsortedList<Integer> ABC_iterPreviousASetD_DBC() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC(); 
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_iterPreviousASetD_DBC = () -> ABC_iterPreviousASetD_DBC();

	/** Scenario: [A,B,C] -> iteratorPreviousBSetD -> [A,D,C] 
	 * @return [A,D,C] after iteratorPreviousBSetD
	 */
	private IndexedUnsortedList<Integer> ABC_iterPreviousBSetD_ADC() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC(); 
		ListIterator<Integer> it = list.listIterator(2);
		it.previous();
		it.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_iterPreviousBSetD_ADC = () -> ABC_iterPreviousBSetD_ADC();

	/** Scenario: [A,B,C] -> iteratorPreviousCSetD -> [A,B,D] 
	 * @return [A,B,D] after iteratorPreviousCSetD
	 */
	private IndexedUnsortedList<Integer> ABC_iterPreviousCSetD_ABD() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC(); 
		ListIterator<Integer> it = list.listIterator(3);
		it.previous();
		it.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_iterPreviousCSetD_ABD = () -> ABC_iterPreviousCSetD_ABD();
	...
	/** Scenario: [A,B] -> iterator add(C) -> [C,A,B] 
	 * @return [C,A,B] after iterator add(C)
	 */
	...
	/** Scenario: [A,B] -> iterator nextA add(C) -> [A,C,B] 
	 * @return [A,C,B] after iterator nextA add(C)
	 */
	private IndexedUnsortedList<Integer> AB_iterNextAAddC_ACB() {
		IndexedUnsortedList<Integer> list = A_addB_AB(); 
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.add(ELEMENT_C);
	...
	private Scenario<Integer> AB_iterNextAAddC_ACB = () -> AB_iterNextAAddC_ACB();

	/** Scenario: [A,B] -> iterator nextB add(C) -> [A,B,C] 
	 * @return [A,B,C] after iterator nextB add(C)
	 */
	private IndexedUnsortedList<Integer> AB_iterNextBAddC_ABC() {
		IndexedUnsortedList<Integer> list = A_addB_AB(); 
		ListIterator<Integer> it = list.listIterator(1);
		it.next();
		it.add(ELEMENT_C);
	...
	private Scenario<Integer> AB_iterNextBAddC_ABC = () -> AB_iterNextBAddC_ABC();

	/** Scenario: [A,B] -> iterator previousA add(C) -> [C,A,B] 
	 * @return [C,A,B] after iterator previousA add(C)
	 */
	private IndexedUnsortedList<Integer> AB_iterPreviousAAddC_CAB() {
		IndexedUnsortedList<Integer> list = A_addB_AB(); 
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.add(ELEMENT_C);
	...
	private Scenario<Integer> AB_iterPreviousAAddC_CAB = () -> AB_iterPreviousAAddC_CAB();

	/** Scenario: [A,B] -> iterator previousB add(C) -> [A,C,B] 
	 * @return [A,C,B] after iterator previousB add(C)
	 */
	private IndexedUnsortedList<Integer> AB_iterPreviousBAddC_ACB() {
		IndexedUnsortedList<Integer> list = A_addB_AB(); 
		ListIterator<Integer> it = list.listIterator(2);
		it.previous();
		it.add(ELEMENT_C);
	...
	private Scenario<Integer> AB_iterPreviousBAddC_ACB = () -> AB_iterPreviousBAddC_ACB();
	...
	private void testSingleElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_iterNextRemove_testIterHasNext", testIterHasNext(iterAfterRemove1(iterAfterNext(scenario.build(), 1)), Result.False));
			printTest(scenarioName + "_iterNextRemove_testIterNext", testIterNext(iterAfterRemove1(iterAfterNext(scenario.build(), 1)), null, Result.NoSuchElement));
			printTest(scenarioName + "_iterNextRemove_testIterRemove", testIterRemove(iterAfterRemove1(iterAfterNext(scenario.build(), 1)), Result.IllegalState));
			// ListIterator
			if (SUPPORTS_LIST_ITERATOR) {
				printTest(scenarioName + "_testListIter", testListIter(scenario.build(), Result.NoException));
				printTest(scenarioName + "_testListIterNeg1", testListIter(scenario.build(), -1, Result.IndexOutOfBounds));
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_iterNext_testIterRemove", testIterRemove(iterAfterNext(scenario.build(), 1), Result.NoException));
			printTest(scenarioName + "_iterNextRemove_testIterHasNext", testIterHasNext(iterAfterRemove1(iterAfterNext(scenario.build(), 1)), Result.True));
			printTest(scenarioName + "_iterNextRemove_testIterNext", testIterNext(iterAfterRemove1(iterAfterNext(scenario.build(), 1)), contents[1], Result.MatchingValue));
			printTest(scenarioName + "_iterNextRemove_testIterRemove", testIterRemove(iterAfterRemove1(iterAfterNext(scenario.build(), 1)), Result.IllegalState));
			...
			printTest(scenarioName + "_iterNextNextRemove_testIterHasNext", testIterHasNext(iterAfterRemove1(iterAfterNext(scenario.build(), 2)), Result.False));
			printTest(scenarioName + "_iterNextNextRemove_testIterNext", testIterNext(iterAfterRemove1(iterAfterNext(scenario.build(), 2)), null, Result.NoSuchElement));
			printTest(scenarioName + "_iterNextNextRemove_testIterRemove", testIterRemove(iterAfterRemove1(iterAfterNext(scenario.build(), 2)), Result.IllegalState));
			printTest(scenarioName + "_iterNextRemoveNext_testIterHasNext", testIterHasNext(iterAfterNext1(iterAfterRemove1(iterAfterNext(scenario.build(), 1))), Result.False));
			printTest(scenarioName + "_iterNextRemoveNext_testIterNext", testIterNext(iterAfterNext1(iterAfterRemove1(iterAfterNext(scenario.build(), 1))), null, Result.NoSuchElement));
			printTest(scenarioName + "_iterNextRemoveNext_testIterRemove", testIterRemove(iterAfterNext1(iterAfterRemove1(iterAfterNext(scenario.build(), 1))), Result.NoException));
		
			// ListIterator NEEDS UPDATE 2 elem
			if (SUPPORTS_LIST_ITERATOR) {
				printTest(scenarioName + "_testListIter", testListIter(scenario.build(), Result.NoException));
				printTest(scenarioName + "_testListIterNeg1", testListIter(scenario.build(), -1, Result.IndexOutOfBounds));
				printTest(scenarioName + "_testListIter0", testListIter(scenario.build(), 0, Result.NoException));
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_iterNextNext_testIterRemove", testIterRemove((iterAfterNext(scenario.build(), 2)), Result.NoException));
			printTest(scenarioName + "_iterNextNextRemove_testIterHasNext", testIterHasNext(iterAfterRemove1(iterAfterNext(scenario.build(), 2)), Result.True));
			printTest(scenarioName + "_iterNextNextRemove_testIterNext", testIterNext(iterAfterRemove1(iterAfterNext(scenario.build(), 2)), contents[2], Result.MatchingValue));
			printTest(scenarioName + "_iterNextNextRemove_testIterRemove", testIterRemove(iterAfterRemove1(iterAfterNext(scenario.build(), 2)), Result.IllegalState));
			printTest(scenarioName + "_iterNextRemoveNext_testIterHasNext", testIterHasNext(iterAfterNext1(iterAfterRemove1(iterAfterNext(scenario.build(), 1))), Result.True));
			printTest(scenarioName + "_iterNextRemoveNext_testIterNext", testIterNext(iterAfterNext1(iterAfterRemove1(iterAfterNext(scenario.build(), 1))), contents[2], Result.MatchingValue));
			printTest(scenarioName + "_iterNextRemoveNext_testIterRemove", testIterRemove(iterAfterNext1(iterAfterRemove1(iterAfterNext(scenario.build(), 1))), Result.NoException));
			printTest(scenarioName + "_iterNextNextRemoveNext_testIterHasNext", testIterHasNext(iterAfterNext1(iterAfterRemove1(iterAfterNext(scenario.build(), 2))), Result.False));
			printTest(scenarioName + "_iterNextNextRemoveNext_testIterNext", testIterNext(iterAfterNext1(iterAfterRemove1(iterAfterNext(scenario.build(), 2))), null, Result.NoSuchElement));
			printTest(scenarioName + "_iterNextNextRemoveNext_testIterRemove", testIterRemove(iterAfterNext1(iterAfterRemove1(iterAfterNext(scenario.build(), 2))), Result.NoException));
			...
			printTest(scenarioName + "_iterNextNextNextRemove_testIterHasNext", testIterHasNext((iterAfterRemove1(iterAfterNext(scenario.build(), 3))), Result.False));
			printTest(scenarioName + "_iterNextNextNextRemove_testIterNext", testIterNext((iterAfterRemove1(iterAfterNext(scenario.build(), 3))), null, Result.NoSuchElement));
			printTest(scenarioName + "_iterNextNextNextRemove_testIterRemove", testIterRemove((iterAfterRemove1(iterAfterNext(scenario.build(), 3))), Result.IllegalState));
			
			// ListIterator NEEDS UPDATE 3 elem
			if (SUPPORTS_LIST_ITERATOR) {
				printTest(scenarioName + "_testListIter", testListIter(scenario.build(), Result.NoException));
				printTest(scenarioName + "_testListIterNeg1", testListIter(scenario.build(), -1, Result.IndexOutOfBounds));
				printTest(scenarioName + "_testListIter0", testListIter(scenario.build(), 0, Result.NoException));
	 ...
	 */
	private Iterator<Integer> iterAfterRemove1(Iterator<Integer> iterator) {
		iterator.remove();
		return iterator;
	}

	/** Helper for testing iterators. Return an Iterator that has had next() called once.
	 * @param iterator
	 * @return same Iterator following a call to next()
	 */
	private Iterator<Integer> iterAfterNext1(Iterator<Integer> iterator) {
		iterator.next();
		return iterator;
	}
